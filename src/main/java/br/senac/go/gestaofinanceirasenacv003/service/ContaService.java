...
import br.senac.go.gestaofinanceirasenacv003.repository.ContaRepository;
...
public class ContaService implements IService<Conta,Integer> {
    ...
    public Conta read(Conta entity) throws Exception {
        ...
        ExampleMatcher caseInsensitiveExampleMatcher = ExampleMatcher.matching().withIgnoreCase();
